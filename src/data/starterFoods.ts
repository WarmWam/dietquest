...
export const STARTER_FOODS: StarterFood[] = [
  ...
  // ─── Other (อาหารเสริม / ผัก / มัน / เครื่องดื่ม) ──────────
  { name: 'Whey BAAM', category: 'other', portion_unit: 'scoop', kcal_per_portion: 120, protein_g_per_portion: 24 },
  { name: 'มันหวานนึ่ง', category: 'other', portion_unit: '100g', kcal_per_portion: 90, protein_g_per_portion: 1.6 },
  { name: 'บร็อกโคลีลวก', category: 'other', portion_unit: '100g', kcal_per_portion: 35, protein_g_per_portion: 3 },
  { name: 'ผักรวมต้ม', category: 'other', portion_unit: '100g', kcal_per_portion: 30, protein_g_per_portion: 2 },
